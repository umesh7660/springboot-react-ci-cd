...
/**
 * DailyBillingData entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "daily_billing_data")
public class DailyBillingData implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = 1L;
	@EmbeddedId
	private DailyBillingDataId id;
	...
	/** default constructor */
	public DailyBillingData() {
	}

	/** minimal constructor */
	public DailyBillingData(DailyBillingDataId id) {
		this.id = id;
	}

	/** full constructor */
	public DailyBillingData(DailyBillingDataId id, Double kwhImport, Double kwhImportT1, Double kwhImportT2,
			Double kwhImportT3, Double kwhImportT4, Double kwhImportT5, Double kwhImportT6, Double kwhImportT7,
			Double kwhImportT8, Double kwhExport, Double kwhExportT1, Double kwhExportT2, Double kwhExportT3,
			Double kwhExportT4, Double kwhExportT5, Double kwhExportT6, Double kwhExportT7, Double kwhExportT8,
			Double kvahImport, Double kvahImportT1, Double kvahImportT2, Double kvahImportT3, Double kvahImportT4,
			Double kvahImportT5, Double kvahImportT6, Double kvahImportT7, Double kvahImportT8, Double kvahExport,
			Double kvahExportT1, Double kvahExportT2, Double kvahExportT3, Double kvahExportT4, Double kvahExportT5,
			Double kvahExportT6, Double kvahExportT7, Double kvahExportT8, Double kwMd, String kwMdOccurtime,
			Double kwMdT1, String kwMdOccurtimeT1, Double kwMdT2, String kwMdOccurtimeT2, Double kwMdT3,
			String kwMdOccurtimeT3, Double kwMdT4, String kwMdOccurtimeT4, Double kwMdT5, String kwMdOccurtimeT5,
			Double kwMdT6, String kwMdOccurtimeT6, Double kwMdT7, String kwMdOccurtimeT7, Double kwMdT8,
			String kwMdOccurtimeT8, Double kweMd, String kweMdOccurtime, Double kweMdT1, String kweMdOccurtimeT1,
			Double kweMdT2, String kweMdOccurtimeT2, Double kweMdT3, String kweMdOccurtimeT3, Double kweMdT4,
			String kweMdOccurtimeT4, Double kweMdT5, String kweMdOccurtimeT5, Double kweMdT6, String kweMdOccurtimeT6,
			Double kweMdT7, String kweMdOccurtimeT7, Double kweMdT8, String kweMdOccurtimeT8, Double kvaMd,
			String kvaMdOccurtime, Double kvaMdT1, String kvaMdOccurtimeT1, Double kvaMdT2, String kvaMdOccurtimeT2,
			Double kvaMdT3, String kvaMdOccurtimeT3, Double kvaMdT4, String kvaMdOccurtimeT4, Double kvaMdT5,
			String kvaMdOccurtimeT5, Double kvaMdT6, String kvaMdOccurtimeT6, Double kvaMdT7, String kvaMdOccurtimeT7,
			Double kvaMdT8, String kvaMdOccurtimeT8, Double kvaeMd, String kvaeMdOccurtime, Double kvaeMdT1,
			String kvaeMdOccurtimeT1, Double kvaeMdT2, String kvaeMdOccurtimeT2, Double kvaeMdT3,
			String kvaeMdOccurtimeT3, Double kvaeMdT4, String kvaeMdOccurtimeT4, Double kvaeMdT5,
			String kvaeMdOccurtimeT5, Double kvaeMdT6, String kvaeMdOccurtimeT6, Double kvaeMdT7,
			String kvaeMdOccurtimeT7, Double kvaeMdT8, String kvaeMdOccurtimeT8, Double cummdKwimport,
			Double cummdKwexport, Double cummdKvaimport, Double cummdKvaexport, Double kvarhQ1, Double kvarhQ2,
			Double kvarhQ3, Double kvarhQ4, String powerOffDuration, String powerOnDuration, Integer tamperCount,
			Double averagePf, Timestamp insertedDate, String accountNo, String extraField1, String extraField2,
			String extraField3, Double mdKwimp, Timestamp mdKwimpOcctime, Double mdKwexp, Timestamp mdKwexpOcctime,
			Double mdKvaimp, Timestamp mdKvaimpOcctime, Double mdKvaexp, Timestamp mdKvaexpOcctime) {
		this.id = id;
	...
	public DailyBillingDataId getId() {
		return this.id;
	}

	public void setId(DailyBillingDataId id) {
		this.id = id;
	}
